...
def convert_velocity(value, unit):
    ...
    if unit == "ft/s":
        convertedunit = value * 0.3048
    elif unit == "km/s":
        convertedunit = value / 3.6
    elif unit == "mi/s":
        convertedunit = value * 0.44704
    else:
        convertedunit = value
...
def convert_acceleration(value, unit):
    ...
    if unit == "ft/s²":
        convertedunit = value / 3.281
    elif unit == "km/s²":
        convertedunit = value * 1000
    elif unit == "mi/s²":
        convertedunit = value * 1609
    else: convertedunit = value
    return convertedunit
